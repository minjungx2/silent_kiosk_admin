                ...
                <div class="card card-profile">
                    ...
                    <div class="card-body" style="text-align: left;">
                        <form class="regStore" action="/admin/store/modify" method="post" accept-charset="UTF-8">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="bmd-label-floating">MID</label> <input
                                            type="text" class="form-control" name='mid' value="${mid}"
                                            readonly="readonly"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div style="margin-bottom: 10px">
                                        <input type="file" name="logoImg" class="form-control"
                                               data-fileName="${store.logoImg }" id="inputGroupFile02"/>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="hidden" class="form-control" name='sno' value="${store.sno}"
                                           readonly="readonly"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div style="margin-bottom: 10px">
                                        <input type="file" name="storeImg" class="form-control" id="inputGroupFile02"
                                               multiple="multiple"/>
                                    </div>
                                    <div class="fileThumb"></div>
                                </div>
                            ...
                            <div class="row storeThumb">
                                <c:forEach items="${storeImg }" var="file">
                                    <div class='col-md-2 delFile${file.suuid}'>
                                        <ul>
                                            <li id='li${file.suuid}' data-suuid='${file.suuid}'
                                                data-sfileName='${file.sfileName}'
                                                data-suploadPath='${file.suploadPath}'>${file.sfileName}
                                                <img src='/admin/common/store/Imgview?link=${store.sno}/s_${file.suuid}_${file.sfileName}'/>
                                                <button class='btn btn-round btn-danger' style='padding: 5px;'
                                                        onclick='delTempImg(event, "${file.suuid}")'>삭제
                                                </button>
                                            </li>
                                        </ul>
                                    </div>
...
<script>
    ...
    document.querySelector(".regBtn").addEventListener("click", function (e) {
        ...
        service.sendRegister(obj, "/admin/store/modify", csrfTokenValue).then(result => {
            $(".regModal").modal("show")
        })
